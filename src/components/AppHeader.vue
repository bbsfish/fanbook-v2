<template>
  <div class="header" :class="{ 'is-hidden': !isHeaderVisible }">
    <router-link :to="getUrlHash('/')" class="header__logo">Fanbook v2</router-link>
    ...
    <nav class="nav" :class="{ 'is-open': isMenuOpen }">
      <ul class="nav__list">
        ...
        <li class="nav__item"><router-link :to="getUrlHash('/cercles')" class="nav__link" @click="isMenuOpen = false">Cercles</router-link></li>
        <li class="nav__item"><router-link :to="getUrlHash('/upload')" class="nav__link" @click="isMenuOpen = false">Upload</router-link></li>
        <li class="nav__item"><router-link :to="getUrlHash('/login')" class="nav__link" @click="isMenuOpen = false">Login</router-link></li>
        <li class="nav__item" v-if="$store.getters.checkPermission"><button class="nav__link" @click="logout">Logout</button></li>
      </ul>
    </nav>
  </div>
</template>
